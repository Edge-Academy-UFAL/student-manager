    ...
    <Form {...form}>
      ...
      >
        <div className="flex w-full flex-col gap-1">
          ...
          <div className="mt-2 flex flex-row items-start space-y-0 space-x-5">
            <FormField
              control={form.control}
              name="csCheckbox"
              render={({ field }) => (
                <FormItem className="flex flex-row items-center space-y-0 space-x-2 leading-0">
                  <FormControl>
                    <Checkbox
                      checked={field.value}
              ...
              <FormItem className="mt-2">
                <FormControl>
                  <MultipleSelector
                    ...
                    emptyIndicator={
                      <p className="text-md text-center leading-10 text-gray-600 dark:text-gray-400">
...
function TableFiltersDropdown(props: {
  ...
  return (
    <DropdownMenu open={showDropdown} onOpenChange={setShowDropdown}>
      ...
      <DropdownMenuContent className="w-[560px] px-7 py-4">
        <div className="flex flex-col space-y-1.5 pt-3 pb-6 text-center sm:text-left">
