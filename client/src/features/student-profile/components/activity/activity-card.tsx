...
import { formatToCompactBRFormat } from '@/shared/lib/utils';
...
export default function ActivityCard({
  ...
  return (
    <Card className="flex flex-col">
      <CardHeader className="grow p-5">
        ...
        <HoverCard>
          <HoverCardTrigger asChild>
            <div className="mt-auto text-sm text-black/90 dark:text-white/80">
              <p
                ref={descriptionRef}
                className="text-muted-foreground line-clamp-2 h-[40px] break-words"
              >
                {description}
              </p>
            </div>
          ...
          {isClamped && (
            <HoverCardContent className="w-[400px]">
              <p className="text-muted-foreground text-sm break-words dark:text-white/80">
                {description}
              </p>
            </HoverCardContent>
          )}
      ...
      <CardFooter className="text-muted-foreground block p-5">
